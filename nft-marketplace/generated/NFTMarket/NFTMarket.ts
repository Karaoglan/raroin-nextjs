...
export class NFTMarket__fetchItemsListedResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
...
export class NFTMarket extends ethereum.SmartContract {
  ...
  fetchItemsListed(): Array<NFTMarket__fetchItemsListedResultValue0Struct> {
    ...
    return result[0].toTupleArray<
      NFTMarket__fetchItemsListedResultValue0Struct
    >();
  }

  try_fetchItemsListed(): ethereum.CallResult<
    Array<NFTMarket__fetchItemsListedResultValue0Struct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<NFTMarket__fetchItemsListedResultValue0Struct>()
    );
  }
  ...
  fetchMarketItems(): Array<NFTMarket__fetchMarketItemsResultValue0Struct> {
    let result = super.call(
      "fetchMarketItems",
      "fetchMarketItems():((uint256,address,address,uint256,bool,string)[])",
      []
    );
  ...
  fetchMyNFTs(): Array<NFTMarket__fetchMyNFTsResultValue0Struct> {
    let result = super.call(
      "fetchMyNFTs",
      "fetchMyNFTs():((uint256,address,address,uint256,bool,string)[])",
      []
    );
