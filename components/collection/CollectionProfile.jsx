            ...
            <div className="collections space-y-10 mb-30">
              <Link href="collections">
                <div className="collections_item">
                  <a href="item-details" className="images-box space-y-10">
                    <div className="top_imgs">
                      <Image width={100} height={100} src={`/img/items/item_${val.img1}.png`} alt="prv" />
                      <Image width={100} height={100} src={`/img/items/item_${val.img2}.png`} alt="prv" />
                      <Image width={100} height={100} src={`/img/items/item_${val.img3}.png`} alt="prv" />
                    </div>
                    <Image width={100} height={100} src={`/img/items/item_${val.img4}.png`} alt="prv" />
                  </a>
                </div>
              </Link>
              <div className="collections_footer justify-content-between">
                <h5 className="collection_title">
                  <Link href="profile">{val.title}</Link>
                </h5>
