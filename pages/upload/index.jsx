  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.status == 201) {
        ...
        const transactionNftCreate = await contract.createToken(
          json.uri,
          ethers.utils.parseUnits(data.price, 'ether'),
                ...
                <div className='space-y-20'>
                  ...
                  <div className='space-y-10'>
                    ...
                    <div className=''>
                      <p>
                        <small>
                          Firm will include a link to this URL on this
                          item&apos;s detail page, so that users can click to
                          learn more about it. You are welcome to link to your
                  ...
                  <div className='space-y-10'>
                    ...
                    <div className='d-flex flex-column flex-md-row'>
                      <div className='choose_collection bg_black  '>
                        ...
                        <span className='color_white ml-10 mr-10'></span>
                        <select
